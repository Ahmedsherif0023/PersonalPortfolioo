      ...
      <div className="AboutContainer">
        ...
        <div className="containerz2">
          ...
          <div className="Second-section">
            <h1>Fun Facts</h1>
            <ul>
              <li><p>🦾I lift heavy and debug harder</p></li>
              <li><p>☕Coffe + dark mode = Peak productivity</p></li>
              <li><p>😍Lana del rey while Coding ugh</p></li>
              <li><p>😅Dreaming of launching my own dev product oneday</p></li>
            </ul>
          </div>
        </div>
      </div>
